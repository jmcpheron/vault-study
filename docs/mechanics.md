...
<p style="text-align:center; margin: 1em 0;">
  <picture>
    <source srcset="assets/generated/mechanism-exploded-fdm.webp" type="image/webp">
    <img src="assets/generated/mechanism-exploded-fdm.gif"
...
1. **Combination lock → bell crank → ring gear.** Three watchmaker-scale
   ...
   released. See [the combination lock](combination-lock.html).
2. **Ring gear → twelve spur gears.** The ring's 120 internal teeth
   ...
   [gearing-math page](gearing-math.html) walks through where the 5
   comes from.
...
[part-2 of the build series](sources.html); the kernel enforces it in
...
The [interactive page](interactive.html) lets you flip between the
two layouts and see the difference.

## See also

- [Gearing math](gearing-math.html) — module, tooth counts, where 5 : 1 comes from.
- [Interactive builder](interactive.html) — drag the slider, watch the pins extend.
- [Why twelve pins?](why-twelve-pins.html) — the divisor argument and base-12 elegance.
- [The combination lock](combination-lock.html) — the gatekeeper at the start of the chain.
- [Faithful vs FDM](faithful-vs-fdm.html) — what changes when you redesign for 3D printers.
